<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowCategory.aspx.cs" Inherits="mihan_news.admin.ShowCategory" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> نمایش دسته بندی</li>
      </ol>
    </section>
        ...
        <div class="col-md-12 mt-5">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">همه دسته ها</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" AllowPaging="true"
OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="5" CssClass="table table-bordered table-striped"  OnRowDeleting="GridView1_RowDeleting">
<Columns>
 


   <asp:TemplateField>
       <HeaderTemplate >عنوان دسته</HeaderTemplate>
       <ItemTemplate>
             <asp:Label ID="lblTitle" runat="server" Text='<%# Eval("category_name") %>' />
       </ItemTemplate>
