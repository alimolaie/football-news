<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCategry.aspx.cs" Inherits="mihan_news.admin.AddCategry" %>
...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-left">
                   ...
                   <asp:Button ID="Button1" runat="server" Text="خروج" CssClass="btn btn-default btn-flat"/>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> دسته بندی</a></li>
        ...
        <div class="col-md-12 mt-5">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                ...
                <asp:TextBox ID="categorayNameBtn" runat="server" CssClass="form-control" placeholder="لطفا نام دسته را وارد کنید"></asp:TextBox>
                </div>
              ...
              <asp:Button ID="btn_addCategory" runat="server" Text="ارسال" CssClass="btn btn-primary" OnClick="btn_addCategory_Click"/>
              <br />
                      <asp:Label ID="sucessLbl" runat="server" Text="دسته مورد نظر باموفقیت ارسال شد" ForeColor="Green" Visible="false"></asp:Label>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="نام دسته الزامی است" ForeColor="Red" ControlToValidate="categorayNameBtn"></asp:RequiredFieldValidator>
                   </div>
